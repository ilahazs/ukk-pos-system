<nav class="navbar navbar-expand navbar-light navbar-bg">
   {{-- <a class="sidebar-toggle-custom">
      <i class="hamburger align-self-center"></i>
      <input type="hidden" value="compact" name="sidebarLayout" class="sidebarLayout" id="sidebarLayout">
      <script>
         let hamburgerSidebar = document.getElementById('sidebarLayout');
         if (hamburgerSidebar.value == "compact") {
   ...
   <form class="d-none d-sm-inline-block">
      <div class="input-group input-group-navbar">
         <input type="text" class="form-control" placeholder="Search Pages ..." aria-label="Search">
