   ...
   <div class="navbar-header">
      <div class="d-flex">
            ...
            <a href="index.html" class="logo logo-light">
               ...
               <span class="logo-lg">
                 {{--  <div class="row">
                  ...
                  <h5 class="text-light"> Cafe Ngopi</h3>
                  </div> --}}
         ...
         {{-- <div class="dropdown dropdown-mega d-none d-lg-block ms-2">
            ...
            <div class="dropdown-menu dropdown-megamenu" width="400px">
               <div class="row">
      ...
      <div class="d-flex">
         ...
         <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
               ...
               <img class="rounded-circle header-profile-user" src="{{ asset('') }}assets/images/users/waifu.png"
                  alt="Header Avatar">
               <span class="d-none d-xl-inline-block ms-1" key="t-username">{{ Auth::user()->name }}</span>
